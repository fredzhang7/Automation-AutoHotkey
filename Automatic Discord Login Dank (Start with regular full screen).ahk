...
numberOfAlts = 10     ;replace with the number of alt accounts you have
...
loop, numberOfAlts{
 ...
 FileReadLine, loginInfo, F:\Fred in Canada\Modding Bots and AI\Auto Hotkey\Discord Bot AHK\Discord Login (Selected Accounts)\Discord Login List.txt, lineNumber
 Send %loginInfo%
 Sleep 700
